    ...
    def initiate_data_transformation(self, ) -> DataTransformationArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                input_feature_train_df = train_df.drop(columns=[os.getenv("TARGET_COLUMN")], axis=1)
                target_feature_train_df = train_df[os.getenv("TARGET_COLUMN")]

                logging.info("Got train features and test features of Training dataset")

                input_feature_train_df['company_age'] = (date.today().year)-input_feature_train_df['yr_of_estab']
                ...
                input_feature_test_df = test_df.drop(columns=[os.getenv("TARGET_COLUMN")], axis=1)

                target_feature_test_df = test_df[os.getenv("TARGET_COLUMN")]


                input_feature_test_df['company_age'] = (date.today().year)-input_feature_test_df['yr_of_estab']
