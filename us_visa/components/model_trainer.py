...
from us_visa.entity.estimator import USvisaModel #, OptunaHyperparamTuner
...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            #optuna_optimisation = HyperparamTuner(X_train=x_train,y_train=y_train,X_test= x_test, y_test= y_test)

            #best_score , best_model_best_params = optuna_optimisation.optimize(n_trials=50)
            ...
            # model_name = best_model_best_params.pop('classifier')

            # model = model_mapping[model_name]
            # model_best = model(**best_model_best_params)
